...
const HomePage = () => {
  return (
    <div className="">
      <div className="bg-[#fffff] lg:grid grid-cols-2  lg:px-12 relative">
        <div className="col-span-1">
          <p className="text-green-400 text-8xl font-bold font-['Karma'] pb-6">
            I am
          </p>
          <p className="text-green-400 text-8xl font-bold font-['Karma'] ">
            Designer
          </p>
